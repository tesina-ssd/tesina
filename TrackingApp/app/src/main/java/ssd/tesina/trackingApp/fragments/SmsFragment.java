...
public class SmsFragment extends Fragment {
    ...
    public void saveData() {
        SharedPreferences sharedPreferences = Objects.requireNonNull(getContext()).getSharedPreferences(Constants.SHARED_PREFS, MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.putString(Constants.TEXT_KEYWORD, txtkeyword.getText().toString());
        //editor.putBoolean(SWITCH_ENABLESMS, enableSettings.isChecked());
        editor.putBoolean(Constants.SWITCH_GOOGLEMAPS_SMS, swgoogleMapsSMS.isChecked());
        editor.putBoolean(Constants.SWITCH_LOCATION_SMS, swlocationSms.isChecked());
        editor.putBoolean(Constants.SWITCH_SINGLE_SMS, swSingleSms.isChecked());
        editor.apply();
    ...
    public void loadData() {
        ...
        keyoword = sharedPreferences.getString(Constants.TEXT_KEYWORD, "");
        //switchEnablesms = sharedPreferences.getBoolean(SWITCH_ENABLESMS, false);
        boolGoogleMapsSms = sharedPreferences.getBoolean(Constants.SWITCH_GOOGLEMAPS_SMS, false);
        boolLocationSms = sharedPreferences.getBoolean(Constants.SWITCH_LOCATION_SMS, false);
        boolSingleSms = sharedPreferences.getBoolean(Constants.SWITCH_SINGLE_SMS, false);
    }
